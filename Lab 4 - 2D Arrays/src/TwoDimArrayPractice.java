...
public class TwoDimArrayPractice extends JFrame
{
   ...
   */
   public void printArray( )
   {
    ...
    for (int i = 0; i < intArray.length; i++) { // goes through each row of the Array
    	
    	for (int j = 0; j < intArray[i].length; j++) { // goes through each column of the Array
    		
    		System.out.print(intArray[i][j] + " "); // prints the elements of the the Array with space between them
    		animate(i, j);
    	}
   ...
   */
   public void setValues( int value, int row )
   {
    ...
    // Write your code here:
	   ...
	   for (int j = 0; j < intArray[row].length; j++) { // sets the same value to each column of a single row
   ...
   */
   public int findMinimum( int column )
   {
    ...
    // Write your code here:
	   ...
	   for (int i = 0; i < intArray.length; i++) { // finds the minimum value in a single column
   ...
   */
   public int countFound( int value )
   {
    ...
    // Write your code here:
	  ...
	  // column to find the number of times a specific element of the array is repeated
	   for (int i = 0; i < intArray.length; i++) { 
